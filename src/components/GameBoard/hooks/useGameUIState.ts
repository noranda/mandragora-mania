 ...
 *   - basePositions, setBasePositions: DOMRect positions and setter for base panels
 *   - hexPositions, setHexPositions: DOMRect positions and setter for hexes
 *   - statsOpen, setStatsOpen: Modal open state and setter
 *   - boardAreaContainerRef, boardRef: Refs for board containers
 *   - opponentBaseAnchorRef, opponentBasePanelRef, playerBaseAnchorRef, playerBasePanelRef: Refs for base anchors/panels
 *
 * Usage:
 *   const {
