        ...
        >
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-purple-400">
              Mandragora Mania Rules
            </h3>

            <div>
              <h4 className="mb-1 font-semibold text-pink-400">Overview</h4>
              <p>
                Battle for jingly by moving your mandragora pieces to the goal.
                Your goal is the blue one on the right, while your
                opponent&apos;s is the green one on the left.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Three mandragoras are placed in each of the eight game areas.
                Choose from five starting patterns (A through E) or use the
                default random setting.
              </p>
            </div>

            <div>
              <h4 className="mb-1 font-semibold text-pink-400">
                Areas & Movement
              </h4>
              <ul className="list-inside list-disc space-y-1">
                <li>The three blue areas in front are yours</li>
                <li>
                  The three green areas at the back are your opponent&apos;s
                </li>
            ...
            <div>
              ...
              <ul className="list-inside list-disc space-y-1">
                <li>
                  Adenium & Citrillus: 3 jingly (first player) / 4 jingly
                  (second player)
                </li>
                <li>
                  Korrigan & Pachypodium: 2 jingly (first player) / 3 jingly
                  (second player)
                </li>
            ...
            <div>
              ...
              <ul className="list-inside list-disc space-y-1">
                <li>
                  If your last moving piece reaches the goal, you get an extra
                  turn
                </li>
                <li>
                  If your piece reaches the opponent&apos;s goal, it returns to
                  your area
                </li>
